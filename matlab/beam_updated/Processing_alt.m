...
cells = csvread('./../../build/bin/beam_updated/search_cells.csv');
...
nodes = csvread('./../../build/bin/beam_updated/nodes.csv');

hold on
plot(nodes(:,1),nodes(:,2),'r.');

 boundary_nodes = csvread('./../../build/bin/beam_updated/boundary.txt');
...
sizeA = [2 inf];
formatSpec = '%f %f';
fileID = fopen('./../../build/bin/beam_updated/loadDisp.txt','r');
