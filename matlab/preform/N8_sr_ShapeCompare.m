...
filename = strcat(path,'displacement_',num2str(plotFiles(25)),'.csv');
disp = csvread(filename,1);
...
outer_coords_i = outer_coord(:,:,floor(11*end/24));
hold on 
...
%                           PLOT 3
% -------------------------------------------------------------------------%
filename = strcat(path,'displacement_',num2str(plotFiles(100)),'.csv');
disp = csvread(filename,1);
