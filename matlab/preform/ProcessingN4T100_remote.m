...
PLOT_GRAPHS = false;
JOB_ID = string(296169);


path = strcat('~/Documents/remote/',JOB_ID,'/Displacement/');
pathSR = strcat('~/Documents/remote/',JOB_ID,'/srRod/');
...
file_pressure = strcat('~/Documents/remote/',JOB_ID,'/pressureTime.txt');
