...
double PRESASURE_DELAY = 0.014; // 0.014 for n6t105 
...
const int PLOT_POINT = 112;

// stretch rod
//const double DISP_ROD_MAX = 132; // N4T100;
const double DISP_ROD_MAX = -132; // N2T100;
...
int main(int argc, char** argv) {
	...
	matParams->ve[19] = 0.653e6;// gamma0_ref = 0.653
	 ...
	 matParams->ve[21] = 122.95;// Tinf 152.95
	 matParams->ve[22] = 0.1565;// C1
	 matParams->ve[23] = 39.937;// C2
	 matParams->ve[24] = 0.9878;// beta
	 matParams->ve[25] = 0.33;// poissons ratio
	...
	double aReduced = 0.000585;//0.0003924; // 0.000154 // 0.000614 // 0.000585
 ...
 // 	double a3 = 1.6212e6;
	...
	for ( int i = 0 ; i < numPointsRod ; i++){
		...
		// either 10.3 or 9
		srNodes->me[i][1] =8.8+stretchRodRad*sin(theta);
